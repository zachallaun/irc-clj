...
(facts "params"
  ...
  (gen-parse-list (str "command arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 arg9 arg10 "
                       "arg11 arg12 arg13 arg14 :trailing"))
  ...
  (insta/failure? (gen-parse-list (str "command arg1 arg2 arg3 arg4 arg5 arg6 arg7 "
...
(facts "spaces"
  ...
  (gen-parse-list (str "command arg1 arg2 arg3 arg4 arg5 arg6 arg7 arg8 arg9 arg10 arg11 "
                       "arg12 arg13 arg14 :trailing   "))
  => [[:COMMAND "command"] [:PARAMS "arg1" "arg2" "arg3" "arg4" "arg5" "arg6"
                            "arg7" "arg8" "arg9" "arg10" "arg11" "arg12"
                            "arg13" "arg14" "trailing   "]]
...
(facts "gen-parse-map"
  (gen-parse-map [[:PREFIX "prefix"] [:COMMAND "command"] [:PARAMS "arg1" "arg2"]])
...
(facts "make-command"
  (make-command {:command :invalid}) => {:command :invalid :invalid :unknown-command}
  )
...
(facts "make-command nick"
  (make-command {:command "nick"}) => {:command :nick :invalid :no-nickname-given}
...
(facts "make-command user"
  ...
  (make-command {:command "user" :params ["user" "mode" "unused" "realname" "extra"]})
  => {:command :user :user "user" :mode "mode" :realname "realname"}
  )
...
(facts "make-command topic"
  (make-command {:command "topic"}) => {:command :topic :invalid :need-more-params}
...
(facts "make-command privmsg"
  (make-command {:command "privmsg"}) => {:command :privmsg :invalid :no-recipient}
